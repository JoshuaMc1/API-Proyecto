...
<head>
    ...
    <title></title>
    <meta name="description" content="Cambio de contraseña exitosa.">
    <style type="text/css">
        a:hover {
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Tu contraseña ya se a actualizado exitosamente, ahora puedes seguir utilizando nuestra aplicación.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
