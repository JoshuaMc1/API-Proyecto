                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            ...
                                            <br>
                                            Recibimos una solicitud para restablecer tu contraseña de <span style="font-weight: bold;">Supermercado el econmico</span>.
                                            Ingresa el siguiente código para restablecer la contraseña:
                                        </p>
                                        <br>
                                        <br>
                                        <br>
                                        <div style="background-color: #40A72E; color: #fff; font-size: 22pt; border-radius: 25px; margin: 1rem; padding: 1rem; text-align: center;">
                                            <span>{{Codigo}}</span>
                                        </div>
                                        <br>
                                        <br>
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Debe ingresar este codigo en la aplicación para poder restablecer la contraseña de su cuenta.
                                            <br>
                                            <br>
                                            <div style="text-align: left; color:#455056; font-size:12px;line-height:24px; margin:0;">
                                                Este mensaje se envío a <span style="font-weight: bold; color: #1411bd;">{{Correo}}</span>
                                            </div>
                                        </p>
                                    </td>
                                </tr>
